...
function LoginContent() {
  ...
  return (
    <div className="min-h-screen w-full flex bg-black text-white selection:bg-indigo-500/30 overflow-hidden relative">
      
      {/* =========================================================
          MOBILE BACKGROUND (Visible only on lg:hidden)
          This ensures phones get the premium vibe too.
      ========================================================= */}
      <div className="absolute inset-0 lg:hidden z-0">
         <div className={`absolute top-[-10%] left-[-20%] w-[100%] h-[60%] rounded-full bg-gradient-to-br ${config.gradient} opacity-20 blur-[100px] animate-pulse-slow`}></div>
      ...
      {/* --- LEFT SIDE (DESKTOP) --- */}
      <div className="hidden lg:flex w-1/2 relative overflow-hidden bg-zinc-900 items-center justify-center border-r border-white/5">
        ...
        <div className="relative z-10 max-w-lg px-12">
          ...
          <h1 className="text-5xl font-bold tracking-tight leading-tight mb-6">Simplifying School Management.</h1>
          <p className="text-lg text-zinc-400 leading-relaxed">Experience a seamless, intelligent platform designed to automate attendance.</p>
        </div>
      </div>

      {/* --- RIGHT SIDE (LOGIN FORM) --- */}
      <div className="w-full lg:w-1/2 flex flex-col items-center justify-center p-6 md:p-8 relative z-10">
        
        {/* Back Button */}
        <Link href="/" className="absolute top-8 left-8 flex items-center gap-2 text-zinc-400 hover:text-white transition-colors text-sm font-medium">
        ...
        <div className="lg:hidden mb-8 text-center">
           <h1 className="text-2xl font-bold text-white tracking-tight flex items-center justify-center gap-2">
             <Sparkles className="w-5 h-5 text-indigo-400" /> Project Aalu
           </h1>
        </div>

        <div className="w-full max-w-[400px] bg-black/40 lg:bg-transparent backdrop-blur-xl lg:backdrop-blur-none border lg:border-none border-white/10 p-6 rounded-3xl animate-fade-in-up">
