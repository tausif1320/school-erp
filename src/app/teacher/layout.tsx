  ...
  if (loading) return (
    <div className="min-h-screen bg-black flex items-center justify-center">
      <div className="flex flex-col items-center gap-4">
        ...
        <span className="text-zinc-500 text-xs font-mono uppercase tracking-widest">Loading...</span>
      </div>
    </div>
  );
  ...
  return (
    <Link 
      ...
      className={`
        ...
        py-3 rounded-xl transition-all duration-200 mb-1 mx-2 cursor-pointer
        ${isActive ? 'bg-emerald-500/10 text-white' : 'text-zinc-400 hover:bg-white/5 hover:text-white'}
      `}
    >
...
function LogoutButton() {
  ...
  return (
    <button onClick={handleLogout} className="flex items-center gap-2 px-4 py-2 rounded-xl text-xs font-bold bg-white/5 text-zinc-400 hover:bg-red-500/10 hover:text-red-400 border border-white/5 transition-all">
